$(document).ready(function() {
    ...
    // fadeIn / fadeOut / fadeToffle
    // fadeIn() : 숨겨져있던 요소를 점점 투명해지면서 노출되는 기능
    // fadeOut() : 노출되어 있는 요소를 점점 사라져가는 기능(투명)
    // fadeToggle() : 노출이 되어 있는 요소는 점점 사라지고, 사라져있는 요소는 점점 노출되어 선명해지는 기능
    ...
    // 투명도는 두번째 인수 값에 삽입하며, 0 ~ 1까지(소수점 포함)입력가능

    $(".btns1").on("click",function() {
        $(".img3").fadeTo(1000,1);  // 인수값 1: 구동시간 / 2: 투명도값
    });
